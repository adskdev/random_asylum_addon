...
# Random Asylum
**Random Asylum** is a chaotic Garry's Mod gamemode where players fight with completely random SWEPs. On every spawn, players receive random weapons from the server's collection, creating unpredictable and hilarious combat scenarios. The gamemode features round-based gameplay with automatic map voting between rounds.
...
* [Random Asylum Music addon source code](https://github.com/adskdev/random_asylum_music)
...
* [Random Asylum (audio-pack) Item Asylum edition](https://steamcommunity.com/sharedfiles/filedetails/?id=3590260323) - Background music for rounds
